...
local configDesc = {
	...
	scalePortrait = "Changes Mel's portrait size as she changes, instead of just with Circe boons. Holy shit they made it canon lmao based",
	scaleMapDoll = "Changes the size of Mel doll between areas, much like Circe's boons do.",
